...
InterceptionContext INTERCEPTION_API interception_create_context(void); //done

void INTERCEPTION_API interception_destroy_context(InterceptionContext context); //done

InterceptionPrecedence INTERCEPTION_API interception_get_precedence(InterceptionContext context, InterceptionDevice device); //done

void INTERCEPTION_API interception_set_precedence(InterceptionContext context, InterceptionDevice device, InterceptionPrecedence precedence); //done

InterceptionFilter INTERCEPTION_API interception_get_filter(InterceptionContext context, InterceptionDevice device); //done

void INTERCEPTION_API interception_set_filter(InterceptionContext context, InterceptionPredicate predicate, InterceptionFilter filter); //done

InterceptionDevice INTERCEPTION_API interception_wait(InterceptionContext context); //done

InterceptionDevice INTERCEPTION_API interception_wait_with_timeout(InterceptionContext context, unsigned long milliseconds); //done

int INTERCEPTION_API interception_send(InterceptionContext context, InterceptionDevice device, const InterceptionStroke *stroke, unsigned int nstroke); //done

int INTERCEPTION_API interception_receive(InterceptionContext context, InterceptionDevice device, InterceptionStroke *stroke, unsigned int nstroke); //done

unsigned int INTERCEPTION_API interception_get_hardware_id(InterceptionContext context, InterceptionDevice device, void *hardware_id_buffer, unsigned int buffer_size); //done

int INTERCEPTION_API interception_is_invalid(InterceptionDevice device); //done

int INTERCEPTION_API interception_is_keyboard(InterceptionDevice device); //done

int INTERCEPTION_API interception_is_mouse(InterceptionDevice device); //done
